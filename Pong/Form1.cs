    ...
    public partial class Form1 : Form
    {
        ...
        private void gameUpdateLoop_Tick(object sender, EventArgs e)
        {
           ...
           // player 2 moves up
            ...
            //collide with p1 and play sound
            ...
            if (ballX < 0)
            {
                ...
                player2Label.Text = "Player 2:  " + player2Score.ToString();
                // --- refresh
                Refresh();
            ...
            if (ballX > this.Width - BALL_SIZE)
            {
                ...
                player1Label.Text = "Player 1:  " + player1Score.ToString();
                // --- refresh
                Refresh();
        ...
        private void GameOver(string winner)
        {
            ...
            startLabel.Text = winner.ToString() + " Wins!";
            Refresh();
